            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              ...
              <div className="flex items-center justify-center">
                <Card className="w-full">
                  <CardHeader>
                    <CardTitle className="text-xl sm:text-2xl">Learn more</CardTitle>
                    <CardDescription className="text-sm sm:text-base">These resources will help you learn, experiment with, and deploy your own Inbound App.</CardDescription>
                  </CardHeader>
                  <CardContent className="grid gap-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <Link 
                        ...
                        rel="noopener noreferrer"
                      >
                        <Card className="hover:bg-accent active:bg-accent transition-colors group">
                          <CardContent className="p-4 flex flex-col items-center">
                            <FileCode className="h-8 w-8 text-primary mb-2" />
                            <p className="text-sm font-medium">Postman Collection with Auth</p>
                            <p className="text-lg sm:text-xl font-bold underline sm:no-underline sm:group-hover:underline sm:group-active:underline decoration-2 underline-offset-4">Test the APIs</p>
                          </CardContent>
                        </Card>
                      </Link>
                      <Link 
                      ...
                      >
                        <Card className="hover:bg-accent active:bg-accent transition-colors group">
                          <CardContent className="p-4 flex flex-col items-center">
                            ...
                            <p className="text-lg sm:text-xl font-bold underline sm:no-underline sm:group-hover:underline sm:group-active:underline decoration-2 underline-offset-4">Descope Docs Site</p>
                          </CardContent>
                        </Card>
                      </Link>
                      <Link 
                      ...
                      >
                        <Card className="hover:bg-accent active:bg-accent transition-colors group">
                          <CardContent className="p-4 flex flex-col items-center">
                            ...
                            <p className="text-lg sm:text-xl font-bold underline sm:no-underline sm:group-hover:underline sm:group-active:underline decoration-2 underline-offset-4">Connected Agent</p>
                          </CardContent>
                        </Card>
                      </Link>
                      <Link 
                      ...
                      >                        
                        <Card className="hover:bg-accent active:bg-accent transition-colors group">
                          <CardContent className="p-4 flex flex-col items-center">
                            ...
                            <p className="text-lg sm:text-xl font-bold underline sm:no-underline sm:group-hover:underline sm:group-active:underline decoration-2 underline-offset-4">10x CRM</p>
                          </CardContent>
                        </Card>
                      </Link>
                    </div>
