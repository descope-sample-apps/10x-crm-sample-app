export const styles = {
    ...
    cardAccent: "h-2 w-full bg-[#ddf1f1] dark:bg-[#1a2727]",
    ...
    // Info Box
    infoBox: "bg-[#f0f7f7] dark:bg-[#1a2727] rounded-lg p-3 mt-2 mb-4 md:mb-6 flex items-start",
    infoIcon: "h-5 w-5 mt-1 flex-shrink-0 text-[#8cafae] dark:text-[#9fbfbf] mr-2",
    ...
    apiIcon: "mr-2 h-5 w-5 text-[#8cafae] dark:text-[#9fbfbf]",
    apiContent: "pt-0",
    ...
    primaryScope: "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold whitespace-nowrap bg-[#ddf1f1] dark:bg-[#2a3a3a] w-fit",
    optionalScope: "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium whitespace-nowrap bg-[#f0f7f7] dark:bg-[#2a3a3a]/80 w-fit",
    ...
    resourceButton: "w-full h-auto py-5 px-4 flex flex-col items-center justify-between hover:bg-[#f0f7f7] dark:hover:bg-[#1a2727] group",
    resourceIconContainer: "w-12 h-12 rounded-full flex items-center justify-center bg-[#ddf1f1] dark:bg-[#1c2b2b] group-hover:bg-[#c5e0e0] dark:group-hover:bg-[#2a3a3a] transition-colors",
    resourceIcon: "h-6 w-6 text-[#8cafae] dark:text-[#9fbfbf] group-hover:text-[#4e5f5f] dark:group-hover:text-[#c5e0e0]",
    resourceTitle: "text-base md:text-lg font-semibold mt-2 text-foreground dark:text-foreground underline md:no-underline group-hover:underline",
    resourceSubtitle: "text-xs text-muted-foreground mt-1",

    // CTA Section
    ctaSection: "w-full py-6 md:py-8 bg-primary dark:bg-[#1a2727] text-primary-foreground",
    ctaContainer: "container px-4 md:px-6 max-w-6xl mx-auto",
    ctaContent: "flex flex-col items-center text-center space-y-3",
    ctaTitle: "text-2xl font-bold tracking-tighter sm:text-3xl max-w-[90%] md:max-w-none text-primary-foreground",
    ctaDescription: "text-lg md:text-lg max-w-[90%] md:max-w-[800px] opacity-90 text-primary-foreground",
    ctaButtons: "flex flex-col sm:flex-row justify-center gap-3 w-full sm:w-auto",
    ctaButtonPrimary: "w-full sm:w-auto group dark:bg-[#1a2727] dark:text-white dark:hover:bg-[#2a3a3a]",
    ctaButtonSecondary: "w-full sm:w-auto bg-transparent border-white text-white hover:bg-white/10",
    ctaButtonSignUp: "bg-white text-black hover:bg-gray-100 dark:bg-[#4e5f5f] dark:text-white dark:hover:bg-[#3a4a4a] transition-colors duration-200",
